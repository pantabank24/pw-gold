  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300    ${
        isTransparent
          ? isScrolled
            ? "bg-[#cf0723]/80 backdrop-blur-lg shadow-lg border-b-1 border-yellow-500"
            : "bg-transparent"
          : "bg-[#cf0723]/80 backdrop-blur-lg shadow-lg border-b-1 border-yellow-500"
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4 bg-white/20  backdrop-blur-sm border border-white/20 px-3 py-1 rounded-full">
            <a
              href="https://www.facebook.com/profile.php?id=100063554277029"
            ...
            <a
              href="https://line.me/ti/p/F--peOgXdk"
              className="w-8 h-8 flex items-center justify-center rounded-full  hover:bg-white/20 transition-colors"
              target="_blank"
              rel="noopener noreferrer"
            >
