...
export const BannerSlider = () => {
  ...
  const banners = [
    ...
    {
      id: 2,
      title: "รับซื้อทองคำทุกชนิด",
      subtitle:
        "ทองเก่า ทองK เศษทอง กรอบพระ นาก เครื่องเงิน รับเช็ค%ทองและโลหะทุกชนิด ด้วยเครื่องยิงมาตรฐาน",
        ...
        <div className=" flex w-auto rounded-full">
          <Marquee className=" text-sm" pauseOnHover pauseOnClick>
            <span className="font-bold  text-sm ml-3 bg-gradient-to-b from-yellow-100 to-yellow-500 bg-clip-text text-transparent">
              ...
              น้ำหนักทอง) = ราคาทองที่จะได้รับ
              หน้าร้านอยู่ที่สนามพระเครื่องจังหวัดนครศรีธรรมราช
              (ติดห้างสรรพสินค้าเซ็นทรัลนครศรีธรรมราช) ไม่สะดวกมา โทรมาปรึกษากัน
