...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: siteConfig.url,
    images: {
      url: "https://pwgold.com/images/banner2.png",
      width: 1200,
      height: 630,
    },
  },
...
export default function RootLayout({
  ...
  return (
    <html suppressHydrationWarning lang="en">
      <head>
        ...
        <meta
          name="description"
          content="แอปเทรดทองคำ PW Gold Progressive Web App"
        />
        <script
  ...
  `,
      ...
      <title>PW Gold | เช็คราคาทอง ตรวจราคาทอง ประเมินราคาทอง</title>
              ...
              <div className=" flex flex-row gap-x-2">
                ...
                <div className=" flex flex-col">
                  <span className="text-default-600 text-lg bg-gradient-to-b from-white to-gray-500 bg-clip-text text-transparent font-bold">
                    PW Gold นครศรีธรรมราช By ปาล์ม
                  </span>
                  <span className="text-default-600 text-sm">
                    ร้านเปิดทุกวัน 9.00 น. - 18.00 น.
                  </span>
                </div>
              </div>
